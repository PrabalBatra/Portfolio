import{r as k,j as h}from"./index-BWCantKL.js";import{u as Xe,S as qe,R as Q}from"./usePortfolioData-BHKvp-o0.js";import{V as D,U as Z,S as N,D as Ke,a as $e,b as Qe,F as Ye,W as X,L as z,B as ee,E as Ie,c as De,N as Pe,d as le,O as Ne,M as Fe,C as Oe,e as Y,f as J,g as te,h as Je,i as Ge,j as S,R as Ze,P as et,k as Ue,T as ue,A as tt,l as st,m as Re,n as rt,G as it,o as nt,p as at}from"./three.module-DnzDCefj.js";import{S as ot}from"./SectionDissolve-DXBkV2Z6.js";import{S as lt}from"./ScrollIndicator-ab4HiRcC.js";var ct=(()=>{const e=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),t=new Float32Array([0,0,2,0,0,2]),s=new st;return s.setAttribute("position",new Re(e,3)),s.setAttribute("uv",new Re(t,2)),s})(),G=class ce{static get fullscreenGeometry(){return ct}constructor(t="Pass",s=new le,r=new Ne){this.name=t,this.renderer=null,this.scene=s,this.camera=r,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthBlit=!1,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(t){if(this.rtt===t){const s=this.fullscreenMaterial;s!==null&&(s.needsUpdate=!0),this.rtt=!t}}set mainScene(t){}set mainCamera(t){}setRenderer(t){this.renderer=t}isEnabled(){return this.enabled}setEnabled(t){this.enabled=t}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(t){let s=this.screen;s!==null?s.material=t:(s=new Fe(ce.fullscreenGeometry,t),s.frustumCulled=!1,this.scene===null&&(this.scene=new le),this.scene.add(s),this.screen=s)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(t){this.fullscreenMaterial=t}getDepthTexture(){return null}setDepthTexture(t,s=ee){}render(t,s,r,i,n){throw new Error("Render method not implemented!")}setSize(t,s){}initialize(t,s,r){}dispose(){for(const t of Object.keys(this)){const s=this[t];(s instanceof X||s instanceof Ue||s instanceof ue||s instanceof ce)&&this[t].dispose()}this.fullscreenMaterial!==null&&this.fullscreenMaterial.dispose()}},ut=class extends G{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(e,t,s,r,i){const n=e.state.buffers.stencil;n.setLocked(!1),n.setTest(!1)}},dt=`#ifdef COLOR_WRITE
#include <common>
...
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=ee){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(const s of this.effects)s.setDepthTexture(e,t)}render(e,t,s,r,i){for(const n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){const n=this.fullscreenMaterial;n.inputBuffer=t.texture,n.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:s),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(const s of this.effects)s.setSize(e,t)}initialize(e,t,s){this.renderer=e;for(const r of this.effects)r.initialize(e,t,s);this.updateMaterial(),s!==void 0&&s!==Z&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1")}dispose(){super.dispose();for(const e of this.effects)e.removeEventListener("change",this.listener),e.dispose()}handleEvent(e){e.type==="change"&&this.recompile()}};const rs=()=>{const t=document.createElement("canvas");t.width=64,t.height=64;const s=t.getContext("2d");if(!s)throw new Error("2D context not available");s.fillStyle="black",s.fillRect(0,0,t.width,t.height);const r=new ue(t);r.minFilter=z,r.magFilter=z,r.generateMipmaps=!1;const i=[];let n=null;const a=64;let o=.1*64;const c=1/a,E=()=>{s.fillStyle="black",s.fillRect(0,0,t.width,t.height)},A=f=>{const T={x:f.x*64,y:(1-f.y)*64};let v=1;const B=M=>Math.sin(M*Math.PI/2),_=M=>-M*(M-2);f.age<a*.3?v=B(f.age/(a*.3)):v=_(1-(f.age-a*.3)/(a*.7))||0,v*=f.force;const g=`${(f.vx+1)/2*255}, ${(f.vy+1)/2*255}, ${v*255}`,x=320;s.shadowOffsetX=x,s.shadowOffsetY=x,s.shadowBlur=o,s.shadowColor=`rgba(${g},${.22*v})`,s.beginPath(),s.fillStyle="rgba(255,0,0,1)",s.arc(T.x-x,T.y-x,o,0,Math.PI*2),s.fill()};return{canvas:t,texture:r,addTouch:f=>{let T=0,v=0,B=0;if(n){const _=f.x-n.x,g=f.y-n.y;if(_===0&&g===0)return;const x=_*_+g*g,M=Math.sqrt(x);v=_/(M||1),B=g/(M||1),T=Math.min(x*1e4,1)}n={x:f.x,y:f.y},i.push({x:f.x,y:f.y,age:0,force:T,vx:v,vy:B})},update:()=>{E();for(let f=i.length-1;f>=0;f--){const T=i[f],v=T.force*c*(1-T.age/a);T.x+=T.vx*v,T.y+=T.vy*v,T.age++,T.age>a&&i.splice(f,1)}for(let f=0;f<i.length;f++)A(i[f]);r.needsUpdate=!0},set radiusScale(f){o=.1*64*f},get radiusScale(){return o/(.1*64)},size:64}},is=(e,t)=>{const s=`
    ...
    `;return new He("LiquidEffect",s,{uniforms:new Map([["uTexture",new S(e)],["uStrength",new S(t?.strength??.025)],["uTime",new S(0)],["uFreq",new S(t?.freq??4.5)]])})},Be={square:0,circle:1,triangle:2,diamond:3},ns=`
void main() {
