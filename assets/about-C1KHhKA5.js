import{r as H,j as h}from"./index-CiXu3gCc.js";import{u as Xe,S as qe,R as Q}from"./usePortfolioData-OkFnUkak.js";import{V as D,U as Z,S as N,D as Ke,a as $e,b as Qe,F as Ye,W as X,L as z,B as ee,E as Ie,c as De,N as Pe,d as le,O as Ne,M as Fe,C as Oe,e as Y,f as J,g as te,h as Je,i as Ge,j as S,R as Ze,P as et,k as Ue,T as ue,A as tt,l as st,m as Re,n as rt,G as it,o as nt,p as at}from"./three.module-DnzDCefj.js";import{S as ot}from"./SectionDissolve-DiE5QS6F.js";import{S as lt}from"./ScrollIndicator-CW4aqxZo.js";var ct=(()=>{const e=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),t=new Float32Array([0,0,2,0,0,2]),s=new st;return s.setAttribute("position",new Re(e,3)),s.setAttribute("uv",new Re(t,2)),s})(),G=class ce{static get fullscreenGeometry(){return ct}constructor(t="Pass",s=new le,r=new Ne){this.name=t,this.renderer=null,this.scene=s,this.camera=r,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthBlit=!1,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(t){if(this.rtt===t){const s=this.fullscreenMaterial;s!==null&&(s.needsUpdate=!0),this.rtt=!t}}set mainScene(t){}set mainCamera(t){}setRenderer(t){this.renderer=t}isEnabled(){return this.enabled}setEnabled(t){this.enabled=t}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(t){let s=this.screen;s!==null?s.material=t:(s=new Fe(ce.fullscreenGeometry,t),s.frustumCulled=!1,this.scene===null&&(this.scene=new le),this.scene.add(s),this.screen=s)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(t){this.fullscreenMaterial=t}getDepthTexture(){return null}setDepthTexture(t,s=ee){}render(t,s,r,i,n){throw new Error("Render method not implemented!")}setSize(t,s){}initialize(t,s,r){}dispose(){for(const t of Object.keys(this)){const s=this[t];(s instanceof X||s instanceof Ue||s instanceof ue||s instanceof ce)&&this[t].dispose()}this.fullscreenMaterial!==null&&this.fullscreenMaterial.dispose()}},ut=class extends G{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(e,t,s,r,i){const n=e.state.buffers.stencil;n.setLocked(!1),n.setTest(!1)}},dt=`#ifdef COLOR_WRITE
#include <common>
