import{r as H,j as h}from"./index-CQ7SepUS.js";import{u as Xe,S as qe,R as Q}from"./usePortfolioData-mEijZdif.js";import{V as D,U as Z,S as N,D as Ke,a as $e,b as Qe,F as Ye,W as X,L as z,B as ee,E as Ie,c as De,N as Pe,d as le,O as Ne,M as Fe,C as Oe,e as Y,f as J,g as te,h as Je,i as Ge,j as S,R as Ze,P as et,k as Ue,T as ue,A as tt,l as st,m as Re,n as rt,G as it,o as nt,p as at}from"./three.module-DnzDCefj.js";import{S as ot}from"./SectionDissolve-Cb1RjVPt.js";import{S as lt}from"./ScrollIndicator-03HeQxUE.js";var ct=(()=>{const e=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),t=new Float32Array([0,0,2,0,0,2]),s=new st;return s.setAttribute("position",new Re(e,3)),s.setAttribute("uv",new Re(t,2)),s})(),G=class ce{static get fullscreenGeometry(){return ct}constructor(t="Pass",s=new le,r=new Ne){this.name=t,this.renderer=null,this.scene=s,this.camera=r,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthBlit=!1,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(t){if(this.rtt===t){const s=this.fullscreenMaterial;s!==null&&(s.needsUpdate=!0),this.rtt=!t}}set mainScene(t){}set mainCamera(t){}setRenderer(t){this.renderer=t}isEnabled(){return this.enabled}setEnabled(t){this.enabled=t}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(t){let s=this.screen;s!==null?s.material=t:(s=new Fe(ce.fullscreenGeometry,t),s.frustumCulled=!1,this.scene===null&&(this.scene=new le),this.scene.add(s),this.screen=s)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(t){this.fullscreenMaterial=t}getDepthTexture(){return null}setDepthTexture(t,s=ee){}render(t,s,r,i,n){throw new Error("Render method not implemented!")}setSize(t,s){}initialize(t,s,r){}dispose(){for(const t of Object.keys(this)){const s=this[t];(s instanceof X||s instanceof Ue||s instanceof ue||s instanceof ce)&&this[t].dispose()}this.fullscreenMaterial!==null&&this.fullscreenMaterial.dispose()}},ut=class extends G{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(e,t,s,r,i){const n=e.state.buffers.stencil;n.setLocked(!1),n.setTest(!1)}},dt=`#ifdef COLOR_WRITE
#include <common>
...
`}if(E+=r+`
`,i!==null&&(U+=i+`
`),c.set(p.FRAGMENT_HEAD,E),c.set(p.FRAGMENT_MAIN_UV,A),c.set(p.FRAGMENT_MAIN_IMAGE,C),c.set(p.VERTEX_HEAD,U),c.set(p.VERTEX_MAIN_SUPPORT,f),t.extensions!==null)for(const g of t.extensions)s.extensions.add(g)}}var we=class extends G{constructor(e,...t){super("EffectPass"),this.fullscreenMaterial=new ts(null,null,null,e),this.listener=s=>this.handleEvent(s),this.effects=[],this.setEffects(t),this.skipRendering=!1,this.minTime=1,this.maxTime=Number.POSITIVE_INFINITY,this.timeScale=1}set mainScene(e){for(const t of this.effects)t.mainScene=e}set mainCamera(e){this.fullscreenMaterial.copyCameraSettings(e);for(const t of this.effects)t.mainCamera=e}get encodeOutput(){return this.fullscreenMaterial.encodeOutput}set encodeOutput(e){this.fullscreenMaterial.encodeOutput=e}get dithering(){return this.fullscreenMaterial.dithering}set dithering(e){const t=this.fullscreenMaterial;t.dithering=e,t.needsUpdate=!0}setEffects(e){for(const t of this.effects)t.removeEventListener("change",this.listener);this.effects=e.sort((t,s)=>s.attributes-t.attributes);for(const t of this.effects)t.addEventListener("change",this.listener)}updateMaterial(){const e=new xt;let t=0;for(const a of this.effects)if(a.blendMode.blendFunction===d.DST)e.attributes|=a.getAttributes()&L.DEPTH;else{if((e.attributes&a.getAttributes()&L.CONVOLUTION)!==0)throw new Error(`Convolution effects cannot be merged (${a.name})`);ss("e"+t++,a,e)}let s=e.shaderParts.get(p.FRAGMENT_HEAD),r=e.shaderParts.get(p.FRAGMENT_MAIN_IMAGE),i=e.shaderParts.get(p.FRAGMENT_MAIN_UV);const n=/\bblend\b/g;for(const a of e.blendModes.values())s+=a.getShaderCode().replace(n,`blend${a.blendFunction}`)+`
...
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=ee){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(const s of this.effects)s.setDepthTexture(e,t)}render(e,t,s,r,i){for(const n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){const n=this.fullscreenMaterial;n.inputBuffer=t.texture,n.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:s),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(const s of this.effects)s.setSize(e,t)}initialize(e,t,s){this.renderer=e;for(const r of this.effects)r.initialize(e,t,s);this.updateMaterial(),s!==void 0&&s!==Z&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1")}dispose(){super.dispose();for(const e of this.effects)e.removeEventListener("change",this.listener),e.dispose()}handleEvent(e){e.type==="change"&&this.recompile()}};const rs=()=>{const t=document.createElement("canvas");t.width=64,t.height=64;const s=t.getContext("2d");if(!s)throw new Error("2D context not available");s.fillStyle="black",s.fillRect(0,0,t.width,t.height);const r=new ue(t);r.minFilter=z,r.magFilter=z,r.generateMipmaps=!1;const i=[];let n=null;const a=64;let o=.1*64;const c=1/a,E=()=>{s.fillStyle="black",s.fillRect(0,0,t.width,t.height)},A=f=>{const T={x:f.x*64,y:(1-f.y)*64};let v=1;const B=M=>Math.sin(M*Math.PI/2),_=M=>-M*(M-2);f.age<a*.3?v=B(f.age/(a*.3)):v=_(1-(f.age-a*.3)/(a*.7))||0,v*=f.force;const g=`${(f.vx+1)/2*255}, ${(f.vy+1)/2*255}, ${v*255}`,x=320;s.shadowOffsetX=x,s.shadowOffsetY=x,s.shadowBlur=o,s.shadowColor=`rgba(${g},${.22*v})`,s.beginPath(),s.fillStyle="rgba(255,0,0,1)",s.arc(T.x-x,T.y-x,o,0,Math.PI*2),s.fill()};return{canvas:t,texture:r,addTouch:f=>{let T=0,v=0,B=0;if(n){const _=f.x-n.x,g=f.y-n.y;if(_===0&&g===0)return;const x=_*_+g*g,M=Math.sqrt(x);v=_/(M||1),B=g/(M||1),T=Math.min(x*1e4,1)}n={x:f.x,y:f.y},i.push({x:f.x,y:f.y,age:0,force:T,vx:v,vy:B})},update:()=>{E();for(let f=i.length-1;f>=0;f--){const T=i[f],v=T.force*c*(1-T.age/a);T.x+=T.vx*v,T.y+=T.vy*v,T.age++,T.age>a&&i.splice(f,1)}for(let f=0;f<i.length;f++)A(i[f]);r.needsUpdate=!0},set radiusScale(f){o=.1*64*f},get radiusScale(){return o/(.1*64)},size:64}},is=(e,t)=>{const s=`
    ...
    `;return new ke("LiquidEffect",s,{uniforms:new Map([["uTexture",new S(e)],["uStrength",new S(t?.strength??.025)],["uTime",new S(0)],["uFreq",new S(t?.freq??4.5)]])})},Be={square:0,circle:1,triangle:2,diamond:3},ns=`
void main() {
...
`,oe=10,os=({variant:e="circle",pixelSize:t=10,color:s="#38bdf8",className:r,style:i,antialias:n=!1,patternScale:a=3,patternDensity:o=1.2,liquid:c=!0,liquidStrength:E=.12,liquidRadius:A=1.2,pixelSizeJitter:C=.5,enableRipples:U=!0,rippleIntensityScale:f=1.5,rippleThickness:T=.12,rippleSpeed:v=.4,liquidWobbleSpeed:B=5,autoPauseOffscreen:_=!0,speed:g=.6,transparent:x=!0,edgeFade:M=.25,noiseAmount:q=0})=>{const de=H.useRef(null),K=H.useRef({visible:!0}),fe=H.useRef(g),y=H.useRef(null),se=H.useRef(null);return H.useEffect(()=>{const I=de.current;if(!I)return;fe.current=g;const He=["antialias","liquid","noiseAmount"],he={antialias:n,liquid:c,noiseAmount:q};let $=!1;if(!y.current)$=!0;else if(se.current){for(const l of He)if(se.current[l]!==he[l]){$=!0;break}}if($){if(y.current){const u=y.current;u.resizeObserver?.disconnect(),u.intersectionObserver?.disconnect(),cancelAnimationFrame(u.raf),u.quad?.geometry.dispose(),u.material.dispose(),u.composer?.dispose(),u.renderer.dispose(),u.renderer.forceContextLoss(),u.renderer.domElement.parentElement===I&&I.removeChild(u.renderer.domElement),y.current=null}const l=document.createElement("canvas");let m;try{m=new rt({canvas:l,antialias:!1,alpha:!0,powerPreference:"high-performance"})}catch(u){console.error("Three.js WebGLRenderer creation in PixelBlast failed:",u);return}m.domElement.style.width="100%",m.domElement.style.height="100%",m.setPixelRatio(1),I.appendChild(m.domElement),x?m.setClearAlpha(0):m.setClearColor(0,1);const w={uResolution:{value:new D(0,0)},uTime:{value:0},uColor:{value:new Oe(s)},uClickPos:{value:Array.from({length:oe},()=>new D(-1,-1))},uClickTimes:{value:new Float32Array(oe)},uShapeType:{value:Be[e]??1},uPixelSize:{value:t*m.getPixelRatio()},uScale:{value:a},uDensity:{value:o},uPixelJitter:{value:C},uEnableRipples:{value:U?1:0},uRippleSpeed:{value:v},uRippleThickness:{value:T},uRippleIntensity:{value:f},uEdgeFade:{value:M}},V=new le,k=new Ne(-1,1,1,-1,0,1),pe=new te({vertexShader:ns,fragmentShader:as,uniforms:w,transparent:!0,depthTest:!1,depthWrite:!1,glslVersion:it}),ze=new nt(2,2),me=new Fe(ze,pe);V.add(me);const ve=new at,ge=()=>{const u=I.clientWidth||1,b=I.clientHeight||1;m.setSize(u,b,!1),w.uResolution.value.set(m.domElement.width,m.domElement.height),y.current?.composer&&y.current.composer.setSize(m.domElement.width,m.domElement.height),w.uPixelSize.value=t*m.getPixelRatio()};ge();const xe=new ResizeObserver(ge);xe.observe(I);const Ee=(()=>{if(typeof window<"u"&&window.crypto?.getRandomValues){const u=new Uint32Array(1);return window.crypto.getRandomValues(u),u[0]/4294967295}return Math.random()})()*1e3;let R,F,j;if(c){F=rs(),F.radiusScale=A,R=new _e(m);const u=new ye(V,k);j=is(F.texture,{strength:E,freq:B});const b=new we(k,j);b.renderToScreen=!0,R.addPass(u),R.addPass(b)}if(q>0){R||(R=new _e(m),R.addPass(new ye(V,k)));const u=new ke("NoiseEffect","uniform float uTime; uniform float uAmount; float hash(vec2 p){ return fract(sin(dot(p, vec2(127.1,311.7))) * 43758.5453);} void mainUv(inout vec2 uv){} void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){ float n=hash(floor(uv*vec2(1920.0,1080.0))+floor(uTime*60.0)); float g=(n-0.5)*uAmount; outputColor=inputColor+vec4(vec3(g),0.0);} ",{uniforms:new Map([["uTime",new S(0)],["uAmount",new S(q)]])}),b=new we(k,u);b.renderToScreen=!0,R&&R.passes.length>0&&R.passes.forEach(P=>P.renderToScreen=!1),R.addPass(b)}R&&R.setSize(m.domElement.width,m.domElement.height);const be=u=>{const b=m.domElement.getBoundingClientRect(),P=m.domElement.width/b.width,O=m.domElement.height/b.height,ie=(u.clientX-b.left)*P,We=(b.height-(u.clientY-b.top))*O;return{fx:ie,fy:We,w:m.domElement.width,h:m.domElement.height}},Ve=u=>{const b=y.current?.clickIx??0,{fx:P,fy:O}=be(u);w.uClickPos.value[b].set(P,O),w.uClickTimes.value[b]=w.uTime.value,y.current&&(y.current.clickIx=(b+1)%oe)},je=u=>{if(!F)return;const{fx:b,fy:P,w:O,h:ie}=be(u);F.addTouch({x:b/O,y:P/ie})};m.domElement.addEventListener("pointerdown",Ve,{passive:!0}),m.domElement.addEventListener("pointermove",je,{passive:!0});let re=0,W=!1;const Te=()=>{if(_&&!K.current.visible){W=!1;return}if(w.uTime.value=Ee+ve.getElapsedTime()*fe.current,j){const u=j.uniforms.get("uTime");u&&(u.value=w.uTime.value)}R?(F&&F.update(),R.passes.forEach(u=>{const b=u.effects;b&&b.forEach(P=>{const O=P.uniforms?.get("uTime");O&&(O.value=w.uTime.value)})}),R.render()):m.render(V,k),!_||K.current.visible?(re=requestAnimationFrame(Te),W=!0):W=!1},Se=new IntersectionObserver(u=>{K.current.visible=u[0].isIntersecting,K.current.visible&&!W&&(re=requestAnimationFrame(Te),W=!0)},{threshold:.01});Se.observe(I),y.current={renderer:m,scene:V,camera:k,material:pe,clock:ve,clickIx:0,uniforms:w,resizeObserver:xe,intersectionObserver:Se,raf:re,quad:me,timeOffset:Ee,composer:R,touch:F,liquidEffect:j}}else{const l=y.current;if(l.uniforms.uShapeType.value=Be[e]??1,l.uniforms.uPixelSize.value=t*l.renderer.getPixelRatio(),l.uniforms.uColor.value.set(s),l.uniforms.uScale.value=a,l.uniforms.uDensity.value=o,l.uniforms.uPixelJitter.value=C,l.uniforms.uEnableRipples.value=U?1:0,l.uniforms.uRippleIntensity.value=f,l.uniforms.uRippleThickness.value=T,l.uniforms.uRippleSpeed.value=v,l.uniforms.uEdgeFade.value=M,x?l.renderer.setClearAlpha(0):l.renderer.setClearColor(0,1),l.liquidEffect){const m=l.liquidEffect.uniforms.get("uStrength");m&&(m.value=E);const w=l.liquidEffect.uniforms.get("uFreq");w&&(w.value=B)}l.touch&&(l.touch.radiusScale=A)}return se.current=he,()=>{if(y.current&&$||!y.current)return;const l=y.current;l.resizeObserver?.disconnect(),l.intersectionObserver?.disconnect(),cancelAnimationFrame(l.raf),l.quad?.geometry.dispose(),l.material.dispose(),l.composer?.dispose(),l.renderer?.domElement&&(l.renderer.domElement.width=1,l.renderer.domElement.height=1),l.renderer?.dispose(),l.renderer?.forceContextLoss(),l.renderer?.domElement?.parentElement===I&&I.removeChild(l.renderer.domElement),y.current=null}},[n,c,q,t,a,o,U,f,T,v,C,M,x,E,A,B,_,e,s,g]),h.jsx("div",{ref:de,className:`pixel-blast-container ${r??""}`,style:i,"aria-label":"PixelBlast interactive background"})},ls=[{v:"1st",l:"Place @ CU Sharks (Solo)"},{v:"02",l:"Patents Filed"},{v:"100%",l:"Fueled by Caffeine"},{v:"0",l:"Hours of Sleep"},{v:"∞",l:"Bugs Fixed"}];function cs(){const{banner:e,experience:t}=Xe(),s=t.find(n=>n.duration?.toLowerCase().includes("present"))||t[0],r=t.find(n=>!n.duration?.toLowerCase().includes("present"))||t[1],i=[{title:"Education",lines:["B.E. Computer Science","Big Data & Analytics","Chandigarh University","2022 — Present"]},{title:"Current Role",lines:[s?.title||"Apprenticeship Trainee",s?.duration||"June 2025 — Present","Mumbai, India"]},{title:"Past Experience",lines:[r?.title||"Business Analyst Intern",r?.duration||"June — Aug 2024","Bangalore, India"]}];return h.jsxs("section",{id:"about",className:"relative py-32 px-6 overflow-hidden",children:[h.jsx("div",{className:"absolute inset-0 z-0 opacity-30 pointer-events-auto",style:{maskImage:"linear-gradient(to bottom, transparent 0%, black 15%, black 85%, transparent 100%)",WebkitMaskImage:"linear-gradient(to bottom, transparent 0%, black 15%, black 85%, transparent 100%)"},children:h.jsx(os,{variant:"circle",pixelSize:10,color:"#38bdf8",patternScale:3,patternDensity:1.2,pixelSizeJitter:.5,enableRipples:!0,rippleSpeed:.4,rippleThickness:.12,rippleIntensityScale:1.5,liquid:!0,liquidStrength:.12,liquidRadius:1.2,liquidWobbleSpeed:5,speed:.6,edgeFade:.25,transparent:!0})}),h.jsx("div",{className:"absolute inset-0 grid-bg opacity-15 pointer-events-none"}),h.jsx("div",{className:"absolute top-0 left-1/3 w-[500px] h-[500px] rounded-full blur-3xl opacity-20 pointer-events-none",style:{background:"var(--gradient-glow)"}}),h.jsxs(ot,{className:"max-w-7xl mx-auto z-10 pointer-events-none",children:[h.jsx("div",{className:"pointer-events-auto mb-6",children:h.jsx(qe,{num:"01",label:"Identity"})}),h.jsxs("div",{className:"grid lg:grid-cols-12 gap-12 items-center pointer-events-auto",children:[h.jsxs("div",{className:"lg:col-span-5 relative z-20",children:[h.jsx(Q,{variant:"dissolve",children:h.jsxs("h2",{className:"text-5xl md:text-7xl font-light leading-[1] tracking-tight text-white",children:["Who ",h.jsx("span",{className:"italic text-gradient",children:"I am"})]})}),h.jsxs(Q,{delay:.15,variant:"dissolve",children:[h.jsx("p",{className:"mt-8 text-base md:text-lg text-muted-foreground leading-relaxed font-light max-w-md",children:e.description||"A Computer Science Engineer specializing in Big Data Analytics — building intelligent systems that combine Artificial Intelligence, Geospatial Intelligence, and Multi-Agent Reasoning."}),h.jsx("p",{className:"mt-4 text-base text-muted-foreground/80 leading-relaxed font-light max-w-md",children:"Production-grade AI, spatial intelligence platforms, computer vision, and reasoning workflows for real-world problems."})]})]}),h.jsx("div",{className:"lg:col-span-7 grid sm:grid-cols-3 gap-4 relative z-20",children:i.map((n,a)=>h.jsx(Q,{delay:a*.1,variant:"dissolve",children:h.jsxs("div",{className:"rounded-2xl p-6 h-full border border-white/10 bg-[#0d0b12]/85 backdrop-blur-md shadow-2xl hover:border-primary/40 transition-all hover:-translate-y-1 duration-500",children:[h.jsxs("div",{className:"text-[10px] tracking-[0.25em] text-cyan-400 uppercase mb-4 font-mono flex items-center gap-2",children:[h.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-cyan-400 animate-pulse"}),h.jsx("span",{children:n.title})]}),h.jsx("div",{className:"space-y-1.5",children:n.lines.map((o,c)=>h.jsx("div",{className:c===0?"text-white font-medium text-sm":c===n.lines.length-1?"text-xs font-mono text-cyan-300/80":"text-xs text-muted-foreground font-light",children:o},c))})]})},n.title))})]}),h.jsx("div",{className:"mt-20 grid grid-cols-2 md:grid-cols-5 gap-3 pointer-events-auto relative z-20",children:ls.map((n,a)=>h.jsx(Q,{delay:a*.08,variant:"dissolve",children:h.jsxs("div",{className:"rounded-xl p-5 text-center border border-white/10 bg-[#0d0b12]/85 backdrop-blur-md shadow-xl hover:bg-white/[0.06] hover:border-primary/40 transition-all group",children:[h.jsx("div",{className:"text-3xl md:text-4xl font-display font-light text-gradient group-hover:scale-105 transition-transform",children:n.v}),h.jsx("div",{className:"mt-2 text-[10px] tracking-wider text-muted-foreground uppercase font-mono",children:n.l})]})},n.l))})]}),h.jsx(lt,{})]})}function vs(){return h.jsx(cs,{})}export{vs as component};
