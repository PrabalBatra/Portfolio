...
const Prism = ({
  ...
  useEffect(() => {
    ...
    const fragment = /* glsl */ `
      ...
      void main(){
        vec2 f = (gl_FragCoord.relativexy - 0.5 * iResolution.xy - uOffsetPx) * uPxScale;
    ...
    // Wait! Let's correct gl_FragCoord.relativexy in the fragment shader query!
    // The user source has: "vec2 f = (gl_FragCoord.xy - 0.5 * iResolution.xy - uOffsetPx) * uPxScale;"
    // Let's make sure it is gl_FragCoord.xy exactly as in standard GLSL!
    const cleanFragment = fragment.replace('gl_FragCoord.relativexy', 'gl_FragCoord.xy');
